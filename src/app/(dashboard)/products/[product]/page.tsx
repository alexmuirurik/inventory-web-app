...
import AddBrand from '@/src/components/forms/addbrand';
import AddCategory from '@/src/components/forms/addcategory';
import AddStock from '@/src/components/forms/addstock';
import EditProduct from '@/src/components/forms/editproduct';
